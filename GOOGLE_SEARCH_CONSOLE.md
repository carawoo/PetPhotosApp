...
- 사이트 URL: `https://petphotos.vercel.app` (또는 실제 배포된 도메인)
- Google 계정 필요
...
3. URL 입력: `https://petphotos.vercel.app`
4. "계속" 클릭
...
```
https://petphotos.vercel.app/sitemap.xml
```
...
```
https://petphotos.vercel.app/robots.txt
```
